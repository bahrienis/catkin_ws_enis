...
\emph{\color{blue}After the supply was turned off, the LED started to blink. For this experiment, a small firmware was written, which can detect red color, which was lighted by the red color LED.}
