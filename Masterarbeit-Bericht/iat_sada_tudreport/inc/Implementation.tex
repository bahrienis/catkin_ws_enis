...
During the course of this master's thesis, a model automobile which was prepared for the Projectseminar Echtzeitsysteme at Technical University of Darmstadt was used. The chassis, steering mechanism, power train, and engine control were derived from the model-building of a Japanese company, Tamiya. The maximum velocity of the model automobile is approximately 1 m/s and the minimum steering radius is around 90 cm. 
...
\begin{figure}[H]
  \centering
  \subfloat{\includegraphics[width=0.45\textwidth]{./Bilder/Case5_OutputImage.png}\label{fig:Case5_OutputImage}}
  \caption{Output Image(320x240 pixels resolution)}
\end{figure}
