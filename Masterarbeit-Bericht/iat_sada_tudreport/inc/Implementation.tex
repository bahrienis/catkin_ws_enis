...
\emph{\color{blue}Before the results were measured, the frequency of the camera was setted to 10 Frame per Second(FPS) and the power supply was setted to 3.28 Hz. square wave. It means, the LED turns on nearly every 305 ms. for 305 ms. then it turns off for 305 ms.}
