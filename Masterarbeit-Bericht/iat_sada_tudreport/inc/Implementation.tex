...
\begin{figure}[H]
  \centering
  \subfloat[Original Image]{\includegraphics[width=0.3\textwidth]{./Bilder/Case1_inputImg.png}\label{fig:Case1_inputImg}}
  \hfill
  \subfloat[Hough Transformation without Cropping Image]{\includegraphics[width=0.3\textwidth]{./Bilder/Case1_withoutCropped.png}\label{fig:Case1_withoutCropped}}
  \hfill
  \subfloat[Hough Transformation with Cropping Image]{\includegraphics[width=0.3\textwidth]{./Bilder/Case1_withCropped.png}\label{fig:Case1_withCropped}}
...
\begin{figure}[H]
  \centering
  \subfloat{\includegraphics[width=0.45\textwidth]{./Bilder/Case1_Rectangles.png}\label{fig:Case1_Rectangles}}
...
\subsection{Method 3/Case 3 : IPM + Hough Transformation + Rectangle Method + Curve Fitting(v0.5.1)}\label{sec:Case 3}
