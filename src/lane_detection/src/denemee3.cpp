...
int main(int argc, char **argv) {
 ...
 //       bool bSuccess = cap.read(inputImg);
        ...
        GaussianBlur(outputImg, outputImgAfterGaussian, Size(15, 15), 0, 0, BORDER_DEFAULT); //GaussianBlur( src, src, Size(3,3), 0, 0, BORDER_DEFAULT );		 
        imshow("After Gaussian", outputImgAfterGaussian);
...
imshow("After Threshold", outputImgAfterThreshold);
        /// Gradient X
...
imshow("After Edge Detector", grad);
