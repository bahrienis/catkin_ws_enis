...
//    cap.set(CV_CAP_PROP_CONTRAST, 0.1); //change the frame value
   ...
   // namedWindow("MyVideo", CV_WINDOW_AUTOSIZE); //create a window called "MyVideo"
    ...
    for (;;) {
        ...
        int firstpicsize = 100 * ratioofframe;
        int secondpicsize = 150 * ratioofframe;
        int thirdpicsize = 230 * ratioofframe;
...
//        cvtColor(dst, cdst, CV_GRAY2BGR);
        ...
        Rect Rec4(0, 0, widthofframe, secondpicsize);
 //       rectangle(dst, Rec4, Scalar(255), 1, 8, 0);
        ...
        int findredlinesarray1[widthofframe];
        ...
        line(upOutputImggray,Point(0,0),Point(0,heightofframe),Scalar(0,0,150),2,CV_AA);
//        line(upOutputImggray,Point(640,0),Point(640,480),Scalar(0,0,150),2,CV_AA);
        ...
        for (int k = widthofframe-1; k >= 0; k--) {
        ...
        if (thebiggestvalue12 < 30* ratioofframe) {
...
//             circle(inputImg, Point(l[0], (l[1]+firstpicsize)), 1, Scalar(0, 0, 255), 1, CV_AA, 0);
        ...
        Rect Rec5(0, secondpicsize, widthofframe, thirdpicsize);
 //       rectangle(dst, Rec5, Scalar(255), 1, 8, 0);
        ...
        line(downOutputImggray,Point(0,0),Point(0,heightofframe),Scalar(0,0,150),2,CV_AA);
//        line(downOutputImggray,Point(640,0),Point(640,480),Scalar(0,0,150),2,CV_AA);
        ...
        int findredlinesarray2[widthofframe];
        int numOfRedLinesDown = 0;

        for (int kk = widthofframe-1; kk >= 0; kk--) {
