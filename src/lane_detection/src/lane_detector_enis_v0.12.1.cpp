...
int main(int argc, char **argv) {
    ...
    dstPoints.push_back(Point2f(widthofframe / 2 - 50, heightofframe));
    dstPoints.push_back(Point2f(widthofframe / 2 + 50, heightofframe));
    ...
    for (;;) {
		...
		int firstpicsize = 2*heightofframe/10;
        int secondpicsize = 3*heightofframe/10;
        int thirdpicsize = heightofframe/2;
