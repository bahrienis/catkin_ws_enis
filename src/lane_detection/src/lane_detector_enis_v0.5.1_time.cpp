...
clock_t end = clock();
   ...
   double IPM_elapsed_secs = double(end_IPM - begin) / CLOCKS_PER_SEC;
        ...
        cout << "FSP : " << 1000 * FSP_elapsed_secs << endl;
          ...
          double REC_elapsed_secs = double(end_REC - end_FSP) / CLOCKS_PER_SEC;
        printf("%.2f (ms)\r", 1000 * REC_elapsed_secs);
        cout << "REC : " << 1000 * REC_elapsed_secs << endl;
        
        
        
        
          double CF_elapsed_secs = double(end_CF - end_REC) / CLOCKS_PER_SEC;
