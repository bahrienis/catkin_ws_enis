...
//        bool bSuccess = cap.read(inputImg);
  ...
  y_left.push_back(alldetectedpoints.at(i).y);
   ...
   //     curvefitting(numofpointsoffirstlane1new, y11, x11, inputImg, "blue");
   //     curvefitting(numofpointsofsecondlane2new, y22, x22, inputImg, "green");
   //     curvefitting(numofpointsofthirdlane3new, y33, x33, inputImg, "red");
